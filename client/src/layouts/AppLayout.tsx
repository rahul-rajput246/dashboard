...
const AppLayout = ({ children }: AppLayoutProps) => {
  ...
  return (
    <div className="min-h-screen bg-hero-grid px-3 py-3 sm:px-4 sm:py-5 md:px-6 lg:px-8">
      <div className="mx-auto items-start max-w-[1600px] gap-4 sm:gap-6 lg:grid lg:grid-cols-[300px_minmax(0,1fr)] xl:grid-cols-[320px_minmax(0,1fr)] 2xl:grid-cols-[340px_minmax(0,1fr)]">
        <aside className="lg:sticky lg:top-5 h-full rounded-[28px] bg-ink px-4 py-5 text-white shadow-panel sm:rounded-[36px] sm:px-6 sm:py-7">
